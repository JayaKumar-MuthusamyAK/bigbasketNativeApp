package com.bigbasket.testutils;
...
public class TestUtils {
	...
	public static boolean isTestcasesExecutable(String testcases, Xls_Reader xls) {
		...
		for (int rNum = 2; rNum <= xls.getRowCount("Test Cases"); rNum++) {
			...
			if (testcases.equals(xls.getCellData("Test Cases", "TCID", rNum))) {
				...
				// System.out.println(xls.getCellData("Test Cases", "TCID",
				// rNum));
	...
	public static int getNum(String testcases, Xls_Reader xls, String columnName) {
		...
		// System.out.println("Test cases started row number :" +
		// testStartsRowNum);
		...
		for (int rNum = rowStartNum; rNum < (rowStartNum + rows); rNum++) {
			for (int cNum = 0; cNum < cols; cNum++) {
				table.put(xls.getCellData("Test Data", cNum, columnStartNum), xls.getCellData("Test Data", cNum, rNum));
				// System.out.print(xls.getCellData("Test Data", cNum,
				// columnStartNum) + "--"+ xls.getCellData("Test Data", cNum,
				// rNum) + " --");
				// System.out.println(xls.getCellData("Test Data", cNum,
				// columnStartNum));
	...
	public static void main(String[] args) {
		...
		// Xls_Reader xls = new
		// Xls_Reader(System.getProperty("user.dir")+"/src/main/java/com/hybridframework_Selenium/testdata/Test
		// Suite1.xlsx");
